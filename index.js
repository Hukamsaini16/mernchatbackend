...
// CORS setup
app.use(cors({
    origin: process.env.NODE_ENV === "production" ? process.env.ORIGIN : "http://localhost:3000", // Dynamic based on environment
...
// Serve static frontend (React/Vite build) files from the public directory
app.use(express.static(path.join(__dirname, 'public')));
